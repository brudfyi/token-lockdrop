// source: https://github.com/Pure-Peace/melos-flow-contracts/blob/88bc03f59aafd7be8da6a874825336ce5e28b0ac/sdk/typings.d.ts
...
declare module 'flow-js-testing' {
   ...
   * @returns {Promise<any>}
   */
  async function deployContractByName(
  ...
  async function setBlockOffset(offset: number): Promise<any>

  async function getTimestampOffset(): Promise<any>

  async function setTimestampOffset(offset: number): Promise<any>
